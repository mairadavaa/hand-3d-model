...
export default function Home() {
  ...
  return (
    <div style={{ width: "100%", height: "100vh" }}>
      ...
      <div style={{ width: "20px", height: "20px", borderRadius: "50%", backgroundColor:"#D19D75"}} onClick={() => toggleButton(1)}></div>
      ...
      <Canvas style={{ width:"40%", height:"50vh", border:"1px solid black", marginTop:"20px"}} >
